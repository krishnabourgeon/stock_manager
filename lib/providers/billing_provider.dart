...
//   TextEditingController subTotalController = TextEditingController();
//   TextEditingController discountController = TextEditingController();
//   bool isDiscountPercentage = false; // false = flat amount, true = percentage
...
//     double discount = 0;
//     if (discountController.text.isNotEmpty) {
//       double rawDiscount = double.parse(discountController.text);
//       if (isDiscountPercentage) {
//         // Clamp percentage between 0–100
//         if (rawDiscount > 100) rawDiscount = 100;
//         discount = totalAmount * rawDiscount / 100;
//       } else {
...
// }
  ...
  updatePreviewRate() {
    ...
    double afterDiscount = (totalAmount - discount).clamp(0, double.infinity);

    // 3. Re-apply GST on the discounted base (keeps GST in sync)
    double gstAmount = 0;
